...
export const buildSchemaMigrationTaskDescription = ({
  ...
  return [
    ...
    '    "summary": "Target schema added only optional fields and no existing record values needed to change."',
    "  }",
    "}",
    "```",
    "",
    ...
    '    "summary": "Migrated existing record data into the target schema."',
    "  }",
    "}",
    "```",
    "",
