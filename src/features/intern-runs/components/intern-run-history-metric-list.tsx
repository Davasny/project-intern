import type { InternRunHistoryEventMetrics } from "@/features/intern-runs/lib/intern-run-history-event"
import { cn } from "@/lib/utils"

type InternRunHistoryMetricListProps = {
  alignment: "end" | "start"
...
export const InternRunHistoryMetricList = ({
  alignment,
  metrics,
}: InternRunHistoryMetricListProps) => {
