...
type AgentRunHistoryNavigationProps = {
  children: ReactNode
  nextEvent: AgentRunHistoryEvent | null
  onSelectEvent: (eventId: string) => void
  previousEvent: AgentRunHistoryEvent | null
}

export const AgentRunHistoryNavigation = ({
  children,
  nextEvent,
  onSelectEvent,
  previousEvent,
}: AgentRunHistoryNavigationProps) => (
